        ...
        .form__row
          .form__col
            label.form__text-block(
              ...
              input.form__input.form__input--title#title(type="text" name="title" placeholder="Введите название" v-model="work.title")
        ...
        .form__row
          .form__col
            label.form__text-block(
              ...
              input.form__input.form__input--link#link(type="text" name="link" placeholder="Введите ссылку" v-model="work.link")
              .form__text-block-error
                error-tooltip(
        ...
        .form__row.form__row--textarea
          .form__col
            label.form__text-block.form__text-block--textarea(
              ...
              textarea.form__textarea#description(name="description" rows="4" placeholder="Введите описание" v-model="work.description")
              .form__text-block-error
                error-tooltip(
