        ...
        .form__row.form__row--review-author-info
          .form__col.form__col--review
            label.form__text-block(
              ...
              input.form__input.form__input--name#name(type="text" name="name" placeholder="Введите имя" v-model="review.author")
          ...
          .form__col.form__col--review
            label.form__text-block(
              ...
              input.form__input.form__input--position#position(type="text" name="position" placeholder="Введите титул" v-model="review.occ")
              .form__text-block-error
                error-tooltip(
