  ...
  .wrapper__filter
    header.header
      .container.container--header
        .userpic
          .userpic__userphoto
            img(src="../images/content/me.png" class='userjpg' alt="мое лицо")
          .userpic__username Плотников Илья
          ...
          form.section-block.edit-card.edit-card--works(@submit.prevent = 'newWork') 
            ...
            .edit-card__content
              ...
              label.edit-card__label Ссылка
                input(required placeholder = "www.porshe.ru").edit-card__input
              label.edit-card__label Описание
                textarea( rows="5" required placeholder="Порше центр Пулково - является официальным дилером...").edit-card__textarea
              label.edit-card__label Добавление тега
                input(required placeholder = "HTML, Vue.JS").edit-card__input
          ...
          .edited-blocks
            ...
            .section-block.edited-card
              ...
              .edited-card__description
                ...
                .edited-card__text Шко́ла (от др.-греч. σχολή, σχολά — досуг, учебное занятие, школа) — учебное заведение для получения общего образования.
                a(href="#").edited-card__link http://ya.ru
            ...
            .edit-card__content
              .edit-card__row
                label.edit-card__label.edit-card__label--feedback Имя автора
                  input( required placeholder = "Владимир Путин").edit-card__input.edit-card__input--feedback
                label.edit-card__label.edit-card__label--feedback Титул
                  input(required placeholder = "Предприниматель").edit-card__input.edit-card__input--feedback
              label.edit-card__label Отзыв
                textarea( rows="5" required placeholder="Этот разрыв между доходами богатых и бедных мы будем сохранять... (через секунду поправился: «сокращать»).").edit-card__textarea.edit-card__textarea--feedback
              .edit-card__buttons
                button(type = "reset").edit-card__reset Отмена
                button(type = "submit").button.button--submit.button--edit-submit сохранить
          .edited-blocks
            ...
            .section-block.edited-card.edited-card--feedback
              .edited-card__speaker-info
                .edited-card__speaker-picture-box
                  img(src='../images/content/mentors/kovalchuk-sq.png').edited-card__speaker-picture
                .edited-card__speaker-textinfo
                  p.edited-card__speaker-name Мануэ́ль Анто́нио Норье́га Море́но
                  p.edited-card__speaker-position Высший лидер национального освобождения Панамы
              .edited-card__description.edited-card__description--feedback
                .edited-card__text Его отец был бухгалтером, мать — поваром...
                .edited-card__buttons
                  button(type="button").button.button--edit-edited Править
                  button(type="button").button.button--delete-edited Удалить
  .popup
...
.button-login-exit {
  ...
  height: 15px;
  width: 15px;
  background: svg-load("cross.svg", fill = #454c5f, width = 100%, height = 100%)
    no-repeat center;
}
  ...
  methods: {
    newGroup() {
      this.$validate().then(function(sucess) {
        if (sucess) {
          console.log("Тут форма должна полететь на сервер");
        } else {
    ...
    editSkill: function(e) {
      console.log("Редактирование скила");
    },
    editSkillBranchName: function(e) {
      console.log("Редактирование названия ветки скиллов");
    },
    newWork: function(e) {
    ...
    feedbackEdit: function(e) {
      console.log("Редактирование карточки с отзывом");
    }
  },
  validators: {
